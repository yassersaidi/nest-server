...
describe("Users Service", () => {
    ...
    describe('create', () => {
        ...
        it("Should throw conflict exception when email already exists", async () => {
            ...
            await expect(service.create(mockUser)).rejects.toThrow(DefaultHttpException);
            await expect(service.create(mockUser)).rejects.toThrow('testing@mail.com already exists');
        });
    ...
    describe('findUser', () => {
        ...
        it("Should find user by phoneNumber", async () => {
            ...
            const result = await service.findUser({ phoneNumber: mockUser.phoneNumber });
            expect(result).toEqual(mockUser);
        });
    ...
    describe('findById', () => {
        ...
        it("Should throw exception when user not found", async () => {
            ...
            await expect(service.findById("testing-1234"))
                .rejects.toThrow(DefaultHttpException);
        });
    });
    ...
    describe('getMe', () => {
        ...
        it("Should throw exception when user not found", async () => {
            ...
            await expect(service.getMe("testing-1234"))
                .rejects.toThrow(DefaultHttpException);
        });
    });
    ...
    describe('updateUser', () => {
        ...
        it("Should update user successfully", async () => {
            mockDb.returning.mockResolvedValue([{ ...mockUser, username: "newusername" }]);

            const result = await service.updateUser(mockUser.id, { username: "newusername" });
        ...
        it("Should throw exception when user not found", async () => {
            ...
            await expect(service.updateUser("testing-1234", { username: "newusername" }))
                .rejects.toThrow(DefaultHttpException);
        });
    });
    ...
    describe('deleteUser', () => {
        ...
        it("Should throw exception when user not found", async () => {
            ...
            await expect(service.deleteUser("testing-1234"))
                .rejects.toThrow(DefaultHttpException);
        });
    });
    ...
    describe('admin checks', () => {
        ...
        describe('isNotAdmin', () => {
            it("Should throw exception when user is admin", async () => {
                ...
                await expect(service.isNotAdmin(mockUser.id))
                    .rejects.toThrow(DefaultHttpException);
            });
