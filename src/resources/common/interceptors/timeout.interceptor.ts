        ...
        return next.handle().pipe(
            ...
            catchError((err) => {
                if (err instanceof TimeoutError) {
                    throw new DefaultHttpException(`Request timed out after: ${this.timeout / 1000}s `, "The server took too long to respond, please try again later", "Server Timeout", HttpStatus.GATEWAY_TIMEOUT)
                }
